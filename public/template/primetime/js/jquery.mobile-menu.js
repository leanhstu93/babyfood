...
;(function($) {
    ...
    $.fn.mobileMenu = function(options) {        
        ...
        return this.each(function() {
            ...
            var self = $(this);
            var overlay = $('#overlay'), body = $('body'), page = $('#navover'), isOpen = false, expandOneHasOpened = false, expandTowHasOpened = false;
            ...
            function mmInit (){
                ...
                var expandLink = '<span class=\"expand glyphicon glyphicon-plus\"></span>';
            ...
            $('.'+mmCssClass+' > li > span.expand').click(function() {
                if (config.CollapseMenu == true) {
                    ...
                    if (secondLevelSpan.hasClass('open') && $(this).next().next().css('display') === 'none') {   
                        ...
                        if( secondLevelSpan.hasClass('open' )) {
                            secondLevelSpan.removeClass('glyphicon glyphicon-minus').addClass('glyphicon glyphicon-plus');
                        } else {
                            secondLevelSpan.removeClass('glyphicon glyphicon-plus').addClass('glyphicon glyphicon-minus');
                        }
                ...
                if( $( this ).hasClass('glyphicon glyphicon-plus' )) {
                    ...
                    $( this ).removeClass('glyphicon glyphglyphicon glyphicon-minus').addClass('glyphicon glyphicon-plus');
                }
                ...
                if (config.CollapseMenu == true) {
                    ...
                    if (thirdLevelSpan.hasClass('open') && $(this).next().next().css('display') === 'none') {
                        ...
                        if( thirdLevelSpan.hasClass('open')) {
                            thirdLevelSpan.removeClass('glyphicon glyphicon-minus').addClass('glyphicon glyphicon-plus');
                        } else {
                            thirdLevelSpan.removeClass('glyphicon glyphicon-plus').addClass('glyphicon glyphicon-minus');
                        }
            ...
            $('.'+mmCssClass+' li a.active').parent().children('.expand').removeClass('glyphicon glyphicon-plus').addClass('glyphicon glyphicon-minus open');
