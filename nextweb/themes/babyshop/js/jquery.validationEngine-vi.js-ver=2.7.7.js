    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				"ajaxUserCallPhp": {
                    "url": "https://babyshop.mauwebsitedep.com/wp-content/plugins/wysija-newsletters/js/validate/languages/phpajax/ajaxValidateFieldUser.php",
                    // you may want to pass extra data on the ajax call
                    "extraData": "name=eric",
                ...
                "ajaxNameCall": {
				 ...
				 "ajaxNameCallPhp": {
	                    // remote json service location
	                    "url": "https://babyshop.mauwebsitedep.com/wp-content/plugins/wysija-newsletters/js/validate/languages/phpajax/ajaxValidateFieldName.php",
	                    // error
	                    "alertText": "* Tên này được dùng",
	                    // speaks by itself
	                    "alertTextLoad": "* Đang xác nhận, vui lòng chờ"
