...
$config['sess_cookie_name'] = 'mn_sessions';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] ='mn_sessions';
...
$config['sess_table_name']      = 'mn_sessions';
$config['sess_match_ip']        = TRUE;
...
$config['cookie_prefix']	= 'mada_';
$config['cookie_domain']	= '.mada.vn';
$config['cookie_path']		= '/';
