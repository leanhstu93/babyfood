      ...
      <div class="row category_box">
          ...
          <div class="col-sm-9 col-md-10 lindo-left-0">
                <div class="items lindo-pro-style-sp">
                  <?php $i=0; ?>
                  <?php $sql_product = "SELECT Id,title_vn,price, sale_price, images, alias, codepro FROM mn_product WHERE idcat ='".$item_ct['Id']."' OR idcat IN (SELECT Id FROM mn_catelog WHERE parentid='".$item_ct['Id']."' OR parentid IN (SELECT Id FROM mn_catelog WHERE parentid='".$item_ct['Id']."')) AND home=1";
