...
<div class="tbody">
  ...
  <div>
    ...
    <table>
      ...
      <tr>
        <td class = 'title_td'>Họ và tên khách hàng: </td>
        <td><strong><?php echo $cus[0]['fullname'];?></strong></td>
      </tr>
      <tr>
        <td class = 'title_td'>Địa chỉ khách hàng: </td>
        <td><strong><?php echo $cus[0]['address'].", Việt Nam";?></strong></td>
      </tr>
      <tr>
        <td class = 'title_td'>Điện thoại khách hàng: </td>
    ...
    <table class="cart" border="1">
      ...
      <tr>
        ...
        <td align = 'right'><b>
          <?php echo bsVndDot($cus[0]['transfee']); ?> VNĐ
      </tr>
	  <?php if($voucher_sale) { ?>
	   <tr>
        <td colspan = '5' align = 'right'><b>Voucher: <?=$voucher_sale['code']?></b></td>
        <td align = 'right'><b>
          <?php echo 'Giảm ' . bsVndDot($voucher_sale['price']); ?> VNĐ
      </tr>
	  <?php } ?>
	  <tr>
        ...
        <!--   <?php 
			...
			echo  $this->page->bsVndDot($tongcong + $cus[0]['transfee'] - $voucher_sale['price']);
			
		?>
          đ</b></td> -->
          <?php echo  $this->page->bsVndDot($tongcong + $cus[0]['transfee'] - $voucher_sale['price']); ?> VNĐ
      </tr>
	...
	?> )</p> -->
	<p class="money">(Số tiền bằng chữ:
      <?php echo $this->page->readNumber12Digits($tongcong); ?> )</p>
    <p class="kygot">Xin cảm ơn Quý Khách Hàng đã tin tưởng và sử dung dịch vụ của chúng tôi.</p>
  </div>
</div>
</body>
</html>