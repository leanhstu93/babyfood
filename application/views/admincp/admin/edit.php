...
<tr>
    ...
    <td>
        <select name = 'level'>
            <option value='0' <?php echo set_select('level', '0',$info['level']==0?TRUE:FALSE); ?> >- - Chọn nhóm cha - -</option>
			<option value="1" <?php echo set_select('level', '1',$info['level']==1?TRUE:FALSE); ?> >- - Administrator - -</option>
            <option value="2" <?php echo set_select('level', '2',$info['level']==2?TRUE:FALSE); ?> >- - Mod - -</option>
             <option value="3" <?php echo set_select('level', '3',$info['level']==3?TRUE:FALSE); ?> >- - Writer - -</option>
        </select>
...
<tr>
    ...
    <td> <input type="checkbox" value="1" name="ticlock"  <?php echo set_checkbox('ticlock', '1',$info['ticlock']==1?TRUE:FALSE); ?>/> </td>
</tr>
<tr>
<td  ></td>
    <th align = 'left'>
