    ...
    <table border="0">
      <tbody>
        <tr>
          ...
          <td> Quản lý nội dung / Code voucher </td>
        </tr>
      </tbody>
    </table>
  </div>
...
<div class="content">
  <div class="list_button">
    <form method="get" action = "<?php echo base_url('admincp/voucher');?>" >
  ...
  <form action = '<?php echo base_url('admincp/voucher/delete');  ?>' method = 'post'  name="rowsForm" id="rowsForm">
    <table class="view">
      <tr>
        ...
        <th><span onClick="javascript:sortOrder('code','<?php if($this->session->userdata('sortuser')==' code asc') echo 0; else echo 1; ?>');" style="cursor:pointer">Code voucher</span></th>
	...
	?>
      ...
      <?php }else{
		 foreach ($info as $item) { 
			...
			$urledit = base_url('admincp/voucher/edit/'.$item->id);
			$urldel = base_url('admincp/voucher/delete/'.$item->id); 
			$urllogin = base_url('admincp/voucher/loginUser/'.$item->id); 
...
?>
    ...
    <div class="list_button"><a href="/admincp/voucher/add" class="button">Add</a> <a href="/admincp/voucher/export_excel_voucher" class="button">Exprot Excel</a> </div>
    <!--<div class="list_button"> <a href = 'javascript:CheckAll(document.rowsForm.check_list)'  class="button">Check all</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href = 'javascript:UnCheckAll(document.rowsForm.check_list)'  class="button">Uncheck all</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="javascript:confirmDelete('Bạn thật sự muốn xóa',document.rowsForm.check_list)"  class="button">Delete</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="javascript:confirmSave('Bạn có chắc muốn lưu lại','<?php echo  base_url('admincp/voucher/save');?>')" class="button">Save</a> </div>-->
  </form>
</div>
