         ...
         <select name = 'idcat'>
            <option value = ''>- - Chọn chủ đề - -</option>
             <?php 
				...
				?>
                <option value="<?php echo $row['Id'] ?>"  ><?php echo $row['title_vn'] ?></option>
...
<tr>
    ...
    <td> 
    <textarea class="textdes" name="description_vn" id="editor1"><?php echo set_value('description_vn','') ?></textarea>
...
if (typeof CKEDITOR == 'undefined') {
	...
	CKFinder.setupCKEditor( editorContent,'<?php echo BASE_URL ?>public/template/ck/ckfinder/');
}
</script>    