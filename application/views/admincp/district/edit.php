...
<tr>
    ...
    <td> <select name="idcat">
		...
		?>
        <option value="<?php echo $item['Id'] ?>" <?php echo set_select('idmanufacturer', $item['Id'],($item['Id']==$info['idcat'])?TRUE:FALSE); ?> ><?php echo $item['title_vn']; ?></option>
        <?php }} ?>
    </select>
...
<tr>
    ...
    <td> <input type="text" name="ship" value="<?php echo  set_value('ship',$this->page->bsVndDot($info['ship'])); ?>"  style="width:200px" onkeyup="this.value = FormatNumber(this.value);" >
