...
class Smtp{
	...
	****************************************************************************/
	...
	function SendMail($frommail,$tomail,$subject,$message,$fromfullname="Mada.vn")
	{
		  ...
		  $smtp_host ='118.69.175.7';//Dia chi mail server
		  $admin_email = 'info@mada.vn';//User duoc khai bao tren mail server
		  $smtp_username = 'info@mada.vn';//User duoc khai bao tren mail server
		  $smtp_password = '2Dqw4Elg';//Pass cua email nay
